...
import './LoanNFTToken.sol';

contract LoanSystemWithNFT { 
    
    Loan[] loanRequests; 
    LoanToken token;
    LoanNFTToken nftToken;
    address owner; 
    ...
    function setLoanNFTTokens(address loanTokenNFTContract) public { 
        require(msg.sender == owner, "Only the owner can create NFTS");
        nftToken = LoanNFTToken();
    }
